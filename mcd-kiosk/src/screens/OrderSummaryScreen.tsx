...
export default function OrderSummaryScreen() {
  ...
  return (
    <div className="flex flex-col items-center h-full  mx-auto mt-20">
      {/* Header */}
      ...
      <div className="flex-grow">
        ...
        <p className="text-gray-600 text-sm">
          {isExpanded
            ...
            : item.MenuItem.description.length > 100  ?  `${item.MenuItem.description.slice(0, 100)}... ` :  `${item.MenuItem.description.slice(0, 100)} ` }
